...
__webpack_require__(/*! ./waves */ "./resources/js/waves.js"); // App Style Switcher
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  function handlenavbarbg() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#main-wrapper').attr('data-navbarbg') == 'skin6') {
      // do this
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".topbar .navbar").addClass('navbar-light');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".topbar .navbar").removeClass('navbar-dark');
    } else {// do that    
    }
  }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".preloader").fadeOut(); // this is for close icon when navigation open in mobile view

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nav-toggler").on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#main-wrapper").toggleClass("show-sidebar");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nav-toggler i").toggleClass("ti-menu");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".search-box a, .search-box .app-search .srh-btn").on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".app-search").toggle(200);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".app-search input").focus();
  }); // ============================================================== 
  // Resize all elements
  // ============================================================== 

  jquery__WEBPACK_IMPORTED_MODULE_0___default()("body, .page-wrapper").trigger("resize");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".page-wrapper").delay(20).show(); //****************************
  ...
  var setsidebartype = function setsidebartype() {
    ...
    if (width < 1170) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#main-wrapper").attr("data-sidebartype", "mini-sidebar");
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#main-wrapper").attr("data-sidebartype", "full");
    }
  };

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).ready(setsidebartype);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on("resize", setsidebartype);
});
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/login"], () => (__webpack_require__("./resources/js/jquery.min.js")))
